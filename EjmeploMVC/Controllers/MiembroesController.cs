...
namespace EjmeploMVC.Controllers
{
    ...
    public class MiembroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Apellido,Email,Cargo,EquipoId")] Miembro miembro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Apellido,Email,Cargo,EquipoId")] Miembro miembro)
        {
            if (ModelState.IsValid)
            {
