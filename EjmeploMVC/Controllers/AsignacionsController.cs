...
namespace EjmeploMVC.Controllers
{
    ...
    public class AsignacionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Rol,Fecha,MiembroId,TareaId")] Asignacion asignacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Rol,Fecha,MiembroId,TareaId")] Asignacion asignacion)
        {
            if (ModelState.IsValid)
            {
