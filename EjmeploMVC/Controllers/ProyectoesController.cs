...
namespace EjmeploMVC.Controllers
{
    ...
    public class ProyectoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,FechaInicio,FechaFin,Estado,Presupuesto")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,FechaInicio,FechaFin,Estado,Presupuesto")] Proyecto proyecto)
        {
            if (ModelState.IsValid)
            {
