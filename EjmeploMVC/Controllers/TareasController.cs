...
namespace EjmeploMVC.Controllers
{
    ...
    public class TareasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,FechaInicio,FechaFin,Estado,ProyectoId")] Tarea tarea)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,FechaInicio,FechaFin,Estado,ProyectoId")] Tarea tarea)
        {
            if (ModelState.IsValid)
            {
